...
export const removeGameComment                          = (id, gameId) => User_API.delete(`/game/removeGameComment/${id}/${gameId}`)
...
export const toggleGameBookmark                         = (formData) => User_API.post('/game/toggleBookmark', formData)
export const getBookmarkedGames                         = (formData) => User_API.post('/game/getBookmarkedGames', formData)
export const addGameReview                              = (formData) => User_API.post('/game/addReview', formData)
export const deleteGameReview                           = (formData) => User_API.post('/game/deleteReview', formData)
export const getGameReviews                             = (formData) => User_API.post('/game/getGameReviews', formData)
export const getGameCollections                         = (formData) => User_API.post('/game/getCollections', formData)
export const createGameCollection                       = (formData) => User_API.post('/game/createCollection', formData)
export const deleteGameCollection                       = (formData) => User_API.post('/game/deleteCollection', formData)
export const toggleGameInCollection                     = (formData) => User_API.post('/game/toggleGameInCollection', formData)
export const getCollectionGames                         = (formData) => User_API.post('/game/getCollectionGames', formData)
...
export const addProjectCategory                         = (formData) => User_API.post('/project/addCategory', formData)
export const editProjectCategory                        = (formData) => User_API.post('/project/editCategory', formData)
export const removeProjectCategory                      = (formData) => User_API.post('/project/removeCategory', formData)
...
export const bulkDeleteProjects                         = (formData) => User_API.post('/project/bulkDeleteProjects', formData)
export const bulkUpdateProjects                         = (formData) => User_API.post('/project/bulkUpdateProjects', formData)
...
export const updateProjectComment                       = (formData) => User_API.patch('/project/updateProjectComment', formData)
export const removeProjectComment                       = (id, project_id) => User_API.delete(`/project/removeProjectComment/${id}/${project_id}`)
export const toggleProjectLike                          = (formData) => User_API.post('/project/toggleProjectLike', formData)
export const toggleBookmark                             = (formData) => User_API.post('/project/toggleBookmark', formData)
export const getBookmarkedProjects                      = (formData) => User_API.post('/project/getBookmarkedProjects', formData)
export const addCollaborator                            = (formData) => User_API.post('/project/addCollaborator', formData)
export const removeCollaborator                         = (formData) => User_API.post('/project/removeCollaborator', formData)
export const getProjectAnalytics                        = (formData) => User_API.post('/project/getProjectAnalytics', formData)
export const getRelatedProjects                         = (formData) => User_API.post('/project/getRelatedProjects', formData)
export const getLatestProjects                          = (formData) => User_API.post('/project/getLatestProjects', formData)
export const viewProject                                = (formData) => User_API.post('/project/viewProject', formData)
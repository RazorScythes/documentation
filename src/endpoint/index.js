...
/*
    VAULT
*/
export const getVaultStatus                 = () => endpoint.get('/vault/status')
export const setupVault                     = (data) => endpoint.post('/vault/setup', data)
export const unlockVault                    = (data) => endpoint.post('/vault/unlock', data)
export const changeMasterPassword           = (data) => endpoint.post('/vault/change-master-password', data)
export const getVaultEntries                = (params) => endpoint.get('/vault/entries', { params })
export const getVaultEntry                  = (id) => endpoint.get(`/vault/entries/${id}`)
export const createVaultEntry               = (data) => endpoint.post('/vault/entries', data)
export const updateVaultEntry               = (id, data) => endpoint.put(`/vault/entries/${id}`, data)
export const deleteVaultEntry               = (id, params) => endpoint.delete(`/vault/entries/${id}`, { params })
export const restoreVaultEntry              = (id) => endpoint.post(`/vault/entries/${id}/restore`)
export const emptyVaultTrash                = () => endpoint.delete('/vault/trash/empty')
export const bulkMoveEntries                = (data) => endpoint.post('/vault/entries/bulk-move', data)
export const getVaultFolders                = () => endpoint.get('/vault/folders')
export const createVaultFolder              = (data) => endpoint.post('/vault/folders', data)
export const updateVaultFolder              = (id, data) => endpoint.put(`/vault/folders/${id}`, data)
export const deleteVaultFolder              = (id) => endpoint.delete(`/vault/folders/${id}`)
export const shareVaultEntry                = (data) => endpoint.post('/vault/share', data)
export const revokeVaultShare               = (id) => endpoint.delete(`/vault/share/${id}`)
export const getSharedWithMe                = () => endpoint.get('/vault/shared-with-me')
export const getMyShares                    = () => endpoint.get('/vault/my-shares')
export const importVaultEntries             = (data) => endpoint.post('/vault/import', data)
export const exportVaultEntries             = () => endpoint.get('/vault/export')
export const getVaultAuditLogs              = (params) => endpoint.get('/vault/audit-logs', { params })
export const getVaultDevices                = () => endpoint.get('/vault/devices')
export const registerVaultDevice            = (data) => endpoint.post('/vault/devices', data)
export const removeVaultDevice              = (id) => endpoint.delete(`/vault/devices/${id}`)
export const getVaultStats                  = () => endpoint.get('/vault/stats')
